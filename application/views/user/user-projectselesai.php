...
<html>
  <head>
    ...
    <title>User - Project Yang Sudah Selesai</title>
     ...
     <div class="usulan" style="border-style: solid;border-width: thin;border-color: #cccccc;border-radius: 3px; padding-top: 10px;margin-top: 10px;">
       <div class="container">
         ...
         <div class="col-md-1" style="padding-top: 40px; padding-left:0px;">
           <!-- upvote -->
           <a href="<?php echo site_url('c_ManageProject/voteSatisfaction/'.$row->ID_Project) ?>" class="btn btn-default"><span class="glyphicon glyphicon-arrow-up"></span>Satisfied</a>
         </div>
       </div>
     </div>
     <?php } ?>
