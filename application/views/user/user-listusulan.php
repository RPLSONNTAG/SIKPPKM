     ...
     <div class="usulan" style="border-style: solid;border-width: thin;border-color: #cccccc;border-radius: 3px; padding-top: 10px;margin-top: 10px;">
       <div class="container">
         <div class="col-md-1" style="padding-top: 40px; padding-left:0px;">
           <!-- upvote -->
           <a href="<?php echo site_url('c_usulan/addVote/'.$row->id_usulan) ?>" class="btn btn-default"><span class="glyphicon glyphicon-arrow-up"></span> Upvote</a>
         </div>
         <div class="col-sm-10">
           <!-- info sekilas aja -->
           <a href="#">
