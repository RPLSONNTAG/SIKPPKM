              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo site_url("c_ManageProject/getProjectInfo/".$row->ID_Project);?>"><?php echo $row->judul; ?></a></td>
                    <td>
                    <a href="<?php echo site_url("c_ManageProject/deleteProject/".$row->ID_Project);?>">
