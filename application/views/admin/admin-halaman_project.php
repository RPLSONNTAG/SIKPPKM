...
<html>
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
		<title>Admin - Halaman Project</title>
      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          ...
          <div class="" align="right">
            <a href="f5_admin" class="btn btn-default">Lihat Prioritas</a>
            <a href="f6_Admin" class="btn btn-default">Lihat Kepuasan</a>
          </div>
        </div>
        <?php }; ?>
      </div>
